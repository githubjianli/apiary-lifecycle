    ...
    rule {
      ...
      http {
        path {
          ...
          backend {
            service_name = kubernetes_service_v1.beekeeper_path_cleanup[0].metadata[0].name
            service_port = kubernetes_service_v1.beekeeper_path_cleanup[0].spec[0].port[0].target_port
          }
        }
      }
    }
    ...
    rule {
      ...
      http {
        path {
          ...
          backend {
            service_name = kubernetes_service_v1.beekeeper_metadata_cleanup[0].metadata[0].name
            service_port = kubernetes_service_v1.beekeeper_metadata_cleanup[0].spec[0].port[0].target_port
          }
        }
      }
    }
    ...
    rule {
      ...
      http {
        path {
          ...
          backend {
            service_name = kubernetes_service_v1.beekeeper_scheduler_apiary[0].metadata[0].name
            service_port = kubernetes_service_v1.beekeeper_scheduler_apiary[0].spec[0].port[0].target_port
          }
        }
      }
    }
